...
function ReviewItem(props) {
    return (
        <li className={`reviews__item ${props.reviewData.modifier ? 'reviews__item--' + props.reviewData.modifier : ''}`}>
            <div className="reviews__top">
                {props.reviewData.name.length > 0 && 
                    <p className="reviews__author">
                        ...
                        <span className="reviews__author-name">{props.reviewData.name}</span>
                    </p>
                }
                {props.reviewData.city.length > 0 && 
                    <p className="reviews__city">
                        ...
                        <span className="reviews__city-name">
                            {props.reviewData.city}
                        </span>
                    </p>
                }
                <time className="reviews__date">{props.reviewData.date}</time>
            </div>
